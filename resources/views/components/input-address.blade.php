...
<label for="{{ $id }}" class="inline-block w-{{ $width }} {{ $mt !== null ? 'mt-4' : '' }} {{ $ml !== null ? 'ml-2' : '' }} bg-base-input border border-base-button focus-within:border-product-yellow-dark transition-all px-3 py-2 rounded">
    <input
